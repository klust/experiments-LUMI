...
int main(int argc, char** argv) {
    ...
    printf( " - BLAS, with the number of cores used determined by environment variables (_p executables, \n" \
            "   also compiled with OpenMP enabled) or on a single core (_s executables)\n\n" );
