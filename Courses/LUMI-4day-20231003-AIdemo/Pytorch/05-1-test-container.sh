...
export SINGULARITY_BIND="/var/spool/slurmd:/var/spool/slurmd,/opt/cray:/opt/cray,/usr/lib64/libcxi.so.1:/usr/lib64/libcxi.so.1,$PWD:/workdir"

srun -N1 -n1 --gpus 8 -p standard-g \
  singularity exec $SIF /workdir/run-me.sh
