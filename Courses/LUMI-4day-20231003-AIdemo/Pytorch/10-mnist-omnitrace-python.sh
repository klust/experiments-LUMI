...
export PYTHONPATH=/pfs/lustrep2/projappl/project_462000125/samantao-public/omnitools/rocm-5.5.x/omnitrace-master/lib/python/site-packages:\$PYTHONPATH
...
if [ \$RANK -eq 2 ] ; then
   omnitrace-python -- mnist_DDP.py --gpu --modelpath /workdir/mnist/model
else
