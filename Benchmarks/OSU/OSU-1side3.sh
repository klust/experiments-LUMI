#! /bin/bash
#SBATCH --job-name=OSU-1sided-OpenMPI-noCrayWrappers
...
ml lumi-CPEtools/1.1-cpeGNU-23.09-OpenMPI-4.1.6-noCrayWrappers
ml OSU-Micro-Benchmarks/7.3-cpeGNU-23.09-OpenMPI-4.1.6-noCrayWrappers
